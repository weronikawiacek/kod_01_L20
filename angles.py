...
def decimal_deg2dms_deg(decimal_deg):
    ...
    return decimal_deg * (1/1.0169722222222222)
    decimal_deg * (1/1.0169722222222222)
    decimal_deg * (1.1/1.0169722222222222)
...
def dms_deg2decimal_deg(dms_deg):
    ...
    return dms_deg * (1.0169722222222222/1)
    dms_deg * (1.0169722222222222/1)
    dms_deg * (1.0169722222222222/1.1)
